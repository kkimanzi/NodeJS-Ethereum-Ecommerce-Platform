...
const queryBusinessTransactions = async (businessId) => {
    ...
    window.location.href = "view_shareheld_business.html?businessId="+businessId;
...
const displayMyBusinesses = async () => {
    ...
    const myBusinesses = await contract.methods.getShareholderBusinesses().call({from:account});
